...
*The graph above depicts the raw, bivariate, contemporaneous association between youth unemployment level and QoQ real GDP growth rate for Germany, Spain, Italy, and France during 2005-2019. The slopes for the observed countries differ greatly. Spain’s slope is negative and steep. Germany and France’s slopes are nearly flat. And Italy’s slope is positive and shallow, serving as the clearest symptom of the marked level-flow dynamic that muddles the association between the independent and dependent variables beyond what the presence of confounding variables already contributes. That being said, the differences in slopes motivate my hypothesis that country-specific labor protection regulation strictness amplifies increases in youth unemployment levels during periods of negative growth. Indeed, this theorized amplification effect, represented in the coefficient β₁, is what my regression model seeks to assess.*
...
* **Observed Cyclical Driver/Shock Variable (X):** Real GDP Growth Rate — both a cyclical control and the shock variable whose transmission to youth unemployment is hypothesized to vary with EPL strictness (identifying variation: the 2008–2013 Eurozone crisis).
* **Unobserved Confounders (U):** Time-invariant country-specific structures (cultural norms, baseline safety nets), absorbed by country fixed effects. Time-varying country-specific unobservables (e.g., domestic banking crises, education policy shifts) remain a limitation. Time-invariant structural variables shared by all four countries (Eurosystem, ECJ, ECB, etc.), posing no threat because they are constant across the panel and folded into the intercept. Time-varying conditions shared by all four countries contemporaneously (2009 financial crisis, sovereign debt crisis, EBC policy actions, etc.), absorbed by quarter fixed effects.
